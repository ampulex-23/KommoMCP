        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['overdue', 'stats', 'by_entity', 'today', 'without_responsible', 'prioritize', 'reassign', 'postpone', 'plan_day', 'delegate', 'dependencies'],
                        'description': 'Action to perform',
                    },
        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['all', 'leads', 'contacts', 'query', 'related', 'recent', 'similar', 'top_deals', 'deal_context', 'timeline', 'graph'],
        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['next_action', 'pipeline_tips', 'loss_analysis', 'closing_tips', 'objections', 'next_best', 'funnel_optimize'],
        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['enterprise', 'stakeholders', 'review', 'pipeline_review'],
        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['review_deal', 'skill_assessment', 'skill_gaps', 'roleplay'],
        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['suggest', 'objection_response', 'context'],
        ...
        'function': {
            ...
            'parameters': {
                ...
                'properties': {
                    'action': {
                        'type': 'string',
                        'enum': ['presentation', 'proposal', 'case_study'],
